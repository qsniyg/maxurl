...
//
// @require https://cdn.jsdelivr.net/gh/qsniyg/maxurl@f418d9fd374ade589105f6f853883152ec35907d/build/rules.js
// ==/UserScript==
	...
	var _get_bigimage = function() {
	    ...
	    if (typeof $__imu_get_bigimage === "undefined") {
	        ...
	        try {
	            ...
	            if (!bigimage_obj || !bigimage_obj.bigimage) {
	            ...
	            } else if (bigimage_obj.nonce !== "91h8hlk3a0me1og9") {
	                ...
	                require_rules_failed = {
	                    ...
	                    message: "Bad nonce, expected: " + "91h8hlk3a0me1og9"
	                };
	            } else {
